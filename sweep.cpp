...
void Game::GameStartup()
{
    ...
    InitAudioDevice();
    Image image1 = LoadImage("resources/minesweeper_assets/images/flag.png");
    textures[TEXTURE_FLAG] = LoadTextureFromImage(image1);
    UnloadImage(image1);

    Image image2 = LoadImage("resources/minesweeper_assets/images/bomb.png");
    textures[TEXTURE_BOMB] = LoadTextureFromImage(image2);
    UnloadImage(image2);

    sounds[SOUND_ONE] = LoadSound("resources/minesweeper_assets/sounds/bomb.wav");
    sounds[SOUND_TWO] = LoadSound("resources/minesweeper_assets/sounds/start.wav");
    sounds[SOUND_THREE] = LoadSound("resources/minesweeper_assets/sounds/flag.wav");

    music[MUSIC_ONE] = LoadMusicStream("resources/minesweeper_assets/sounds/music.mp3");
